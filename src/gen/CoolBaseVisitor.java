...
public class CoolBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements CoolVisitor<T> {
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitClassdec(CoolParser.ClassdecContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitEntryClassDeclaration(CoolParser.EntryClassDeclarationContext ctx) { return visitChildren(ctx); }
}