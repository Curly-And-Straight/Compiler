...
public class CoolParser extends Parser {
	...
	public static final int
		...
		ISVOID=39, ID=40, NUM=41, CUSTOMTYPE=42, SINGLECOMMENT=43, MULTICOMMENT=44, 
		WS=45;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"NUM", "CUSTOMTYPE", "SINGLECOMMENT", "MULTICOMMENT", "WS"
		};
	}
	...
	public static class ClassDefContext extends ClassDefineContext {
		...
		public List<TerminalNode> CUSTOMTYPE() { return getTokens(CoolParser.CUSTOMTYPE); }
		public TerminalNode CUSTOMTYPE(int i) {
			return getToken(CoolParser.CUSTOMTYPE, i);
		}
	...
	public static class FunctionContext extends FeatureContext {
		...
		public TerminalNode CUSTOMTYPE() { return getToken(CoolParser.CUSTOMTYPE, 0); }
		public TerminalNode OPENBRACE() { return getToken(CoolParser.OPENBRACE, 0); }
